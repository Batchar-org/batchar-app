    ...
    return (
        <View className="w-full flex-row items-center justify-between bg-white px-5 py-3">
            ...
            <View className="flex-row items-center gap-3">
                <TouchableOpacity>
                    <View
                        className="relative h-10 w-10 items-center justify-center rounded-full border-2 border-green-500">
                        <Feather name="bell" size={20} color="#12B76A"/>
                        <View
                            className="absolute -top-1 -right-1 h-4.5 min-w-4.5 items-center justify-center rounded-full bg-red-500">
